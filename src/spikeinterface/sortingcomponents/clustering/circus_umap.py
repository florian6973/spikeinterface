...
class CircusUMAPClustering:
    ...
    def main_function(cls, recording, peaks, params):
        ...
        # print("UMAP main model")
        # tsvd = umap.UMAP(n_components=params["n_svd"][0], random_state=0, n_neighbors=30, min_dist=0.0)
        tsvd.fit(wfs)
        ...
        if len(params["recursive_kwargs"]) == 0:
            ...
            for c in np.unique(peaks["channel_index"]):
                ...
                print("Fitting SVD on %d samples" % len(sub_data))
